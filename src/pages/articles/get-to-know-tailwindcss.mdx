...
> Tailwind A **utility-first CSS framework** packed wcith classes like flex, pt-4, text-center and rotate-90 that can be composed to build any design, directly in your markup.
