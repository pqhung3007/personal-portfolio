          ...
          <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-2 ">
            ...
            >
              ...
              <div className="mt-8 space-y-6 text-base leading-7 text-zinc-600 dark:text-zinc-400">
                <p>
                  I entered the frontend web development zone in late 2021 and
                  it was by far the best decision of my life. The combination of
                ...
                <p>
                  ...
                  I&apos;m still eager to learn more and more. Backend
                  development and UX design seem appealing, and I would surely
                  put them in my bucket list.
                </p>
                <p>
                  When I&apos;m not working on a project, I like to spend my
                  time with books. Whether it is about software requirements,
                  project management or UI/UX design, I&apos;m always looking
                  for new ways to dive deeper and finding inspiration from it.
                  Because I believe that by staying knowledgeable, I can help
                  other people to build better products.
                </p>
              </div>
            </motion.div>
